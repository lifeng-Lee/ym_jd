  ...
  for (let i = 0; i < cookiesArr.length; i++) {
    if (cookiesArr[i]) {
      ...
      if (InviterPin.length != 0) {
        ...
        console.log(`\n您未填写赚金币邀请码变量，开始助力\n`);
        await help2("格","HyPhbIYL8ouFeTXOsXX2FPMpbTB8GMcknFbSJdnSiaw=")
        await help2("峰","X+DmCZT8QyZU6NgISan0XQ==")
        await help2("哥","6E7vgd6UezweNqcVIsVQl282kI9TX6GJIlePvCxYk8M=")
        await help2("姐","vD9oFaJNb23XPJCq50WlzQ==")
        await help2("峰2","1k1U2i5+1mPtuPPhf3KlPw==")
